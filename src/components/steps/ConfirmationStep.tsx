      ...
      <div>
        ...
        <div className="space-y-6">
          <div className="grid grid-cols-8 gap-4">
            ...
            <div className="col-span-7 text-gray-900">{data.name}</div>
          </div>
          ...
          <div className="grid grid-cols-8 gap-4">
            ...
            <div className="col-span-7 text-gray-900">{data.description}</div>
          </div>
          ...
          <div className="grid grid-cols-8 gap-4">
            ...
            <div className="col-span-7 space-y-1">
              {data.selectedRoles.map((role) => (
                <div key={role.id} className="text-gray-900">
                  {role.name}
                </div>
              ))}
            </div>
